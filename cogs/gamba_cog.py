...
class Gamba(commands.Cog):
    ...
    async def start_gamba(self,
        ...
        kekw = discord.utils.find(lambda e: e.name == 'kekw', self.guild.emojis)
        poggers = discord.utils.find(lambda e: e.name == 'POGGERS', self.guild.emojis)
        weirdchamp = discord.utils.find(lambda e: e.name == 'WeirdChamp', self.guild.emojis)
        win_button = GambaButton(poggers, discord.ButtonStyle.green, f'gamba_win_{gamba_id}', self.handle_gamba_win)
        lose_button = GambaButton(kekw, discord.ButtonStyle.red, f'gamba_lose_{gamba_id}', self.handle_gamba_loss)
        cancel_button = GambaButton(weirdchamp, discord.ButtonStyle.grey, f'gamba_cancel_{gamba_id}', self.handle_cancel)
